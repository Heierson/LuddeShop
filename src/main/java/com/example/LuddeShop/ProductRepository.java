...
public class ProductRepository {
    ...
    public ProductRepository() {
        ...
        products.add(new Product(1002, "Floating Floof", "Flytväst", 589, "Hundjackor"));
        products.add(new Product(1003, "Sausage Dog Ultra", "Dunjacka", 2200, "Hundjackor"));
        products.add(new Product(1004, "Sir Barkington III", "Smoking för finare tillställningar", 850, "Hundjackor"));
        products.add(new Product(1005, "Air Puppies", "Street skor för hund", 89, "Hundskor"));
        ...
        products.add(new Product(1007, "Cozy-Pup", "Hundsstrumpor", 975, "Hundskor"));
        products.add(new Product(1008, "Furry Potatoe Satchel", "Modemedveten hundväska", 1500, "Hundväska"));
        products.add(new Product(1009, "Bark Bark", "Hundväska", 3000, "Hundväska"));
